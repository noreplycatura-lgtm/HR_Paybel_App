...
const STATIC_KEYS = [
  'catura_employee_master_data_v1',         // Employee Master & Salary Setup
  'catura_opening_leave_balances_v1',       // Leave Balances
  'catura_leave_applications_v1',           // Leave Applications
  'catura_performance_deductions_v1',       // Performance Deductions
  'catura_simulated_users_v1',              // User Management
  'catura_recent_activities_v1',            // Dashboard Activity
  'catura_logged_in_status_v1',             // Login Status
  'catura_current_logged_in_user_display_name_v1' // User Name
];

// 2. Dynamic Keys Prefixes (Jo har mahine change hoti hain)
const DYNAMIC_PREFIXES = [
  'catura_attendance_raw_data_v4_',  // Attendance Data (All months)
  'catura_attendance_filename_v4_',  // Attendance File Names
  'catura_salary_sheet_edits_v1_',   // Salary Sheet Edits (All months)
  'catura_last_upload_context_v4'    // Last Upload Info
];
